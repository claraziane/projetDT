...
Participants = {'P02'; 'P03'; 'P10'; 'P16'; 'P17'; 'P18';...
                ...
                'P40'; 'P41'; 'P44'};
treadmillCond  = {'noneWalkST';  'stimWalkDT'; 'syncWalkST';  'syncWalkDT'};
overgroundCond = {'noneWalkST'; 'stimWalkODD'; 'syncWalkST'; 'syncWalkODD'};
...
for iParticipant = 1:length(Participants)
    ...
    for iCondition = 1:2:length(treadmillCond)*2
        ...
        IMI(iParticipant, iCondition+1)   = mean(overgroundData.Events.(overgroundCond{iCond}).IMI)/2;
...
% Save
saveas(figure(1), [pathResults '/All/01/treadmillVSoverground/fig_mvtCV.png'])
saveas(figure(2), [pathResults '/All/01/treadmillVSoverground/fig_mvtIMI.png'])
saveas(figure(3), [pathResults '/All/01/treadmillVSoverground/fig_syncConsistency.png'])
